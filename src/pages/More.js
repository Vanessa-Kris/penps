    ...
    <Box sx={{ m: { md: 15, sm: 15, xs: 3 }, pt: { xs: 7, sm: 0, md: 0 } }}>
      ...
      >
        ...
        <Typography variant="p">
          Power and Excellent Nursery and Primary School was established in the
          year 2000 and has been thriving ever since. Over the years, we have
          consistently nurtured and developed outstanding young minds, and we
          continue to do so with unwavering dedication. Our commitment to
          excellence remains our driving force, and we take immense pride in the
          remarkable achievements of our students. As we look towards the
          future, we aspire to further elevate the standards of education,
      ...
      >
        ...
        <Grid item md={6} sm={6} xs={12}>
          <Typography variant="h5">Inter house sports</Typography>
          <Typography variant="p">
      ...
      <Typography align="center" variant="h3" sx={{ mt: 15, fontWeight: 500 }}>
        Meet Our Alumnus
      </Typography>
